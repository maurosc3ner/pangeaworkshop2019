...
1. Check first [http://desktop.arcgis.com/en/arcmap/10.3/get-started/system-requirements/arcgis-desktop-system-requirements.htm](system requirements) to make sure your computer has the hardware and software required for the trial.
...
Support for the ArcGIS Desktop Student Trial is available at [esri.com/trialhelp](esri.com/trialhelp).
